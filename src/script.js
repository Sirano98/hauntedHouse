...
const moveLight = gui.addFolder("Move light")
moveLight.add(moonLight.position, 'x').min(- 5).max(5).step(0.001).name("left and right")
moveLight.add(moonLight.position, 'y').min(- 5).max(5).step(0.001).name("up and down")
moveLight.add(moonLight.position, 'z').min(- 5).max(5).step(0.001).name("backward and forward")
scene.add(moonLight)
